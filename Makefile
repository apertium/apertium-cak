...
pkgdatadir = $(datadir)/apertium-cak
pkgincludedir = $(includedir)/apertium-cak
pkglibdir = $(libdir)/apertium-cak
pkglibexecdir = $(libexecdir)/apertium-cak
...
CONFIG_CLEAN_FILES = apertium-cak.pc
...
am__installdirs = "$(DESTDIR)$(apertium_cakdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_cak_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-cak.pc.in \
...
ACLOCAL = ${SHELL} /home/fran/source/apertium/incubator/apertium-cak/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APERTIUM_CFLAGS = -I/home/fran/local/include/apertium-3.6 -I/home/fran/local/lib/apertium-3.6/include -I/home/fran/local/include/lttoolbox-3.5 -I/usr/include/libxml2
APERTIUM_LIBS = -L/home/fran/local/lib -lapertium3 -llttoolbox3 -lxml2 -lpcre
AUTOCONF = ${SHELL} /home/fran/source/apertium/incubator/apertium-cak/missing autoconf
AUTOHEADER = ${SHELL} /home/fran/source/apertium/incubator/apertium-cak/missing autoheader
AUTOMAKE = ${SHELL} /home/fran/source/apertium/incubator/apertium-cak/missing automake-1.15
AWK = gawk
CGCOMP = /home/fran/local/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"apertium-cak\" -DPACKAGE_TARNAME=\"apertium-cak\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"apertium-cak\ 0.1.0\" -DPACKAGE_BUGREPORT=\"ftyers@prompsit.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"apertium-cak\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/fran/source/apertium/incubator/apertium-cak/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-cak
PACKAGE_BUGREPORT = ftyers@prompsit.com
PACKAGE_NAME = apertium-cak
PACKAGE_STRING = apertium-cak 0.1.0
PACKAGE_TARNAME = apertium-cak
PACKAGE_URL = 
PACKAGE_VERSION = 0.1.0
PATH_SEPARATOR = :
PKG_CONFIG = /usr/bin/pkg-config
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /home/fran/local/lib/pkgconfig:/home/fran/local/share/pkgconfig:/home/fran/local/lib/pkgconfig
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/fran/source/apertium/incubator/apertium-cak
abs_srcdir = /home/fran/source/apertium/incubator/apertium-cak
abs_top_builddir = /home/fran/source/apertium/incubator/apertium-cak
abs_top_srcdir = /home/fran/source/apertium/incubator/apertium-cak
am__leading_dot = .
...
install_sh = ${SHELL} /home/fran/source/apertium/incubator/apertium-cak/install-sh
...
$(am__aclocal_m4_deps):
apertium-cak.pc: $(top_builddir)/config.status $(srcdir)/apertium-cak.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_cakDATA: $(apertium_cak_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_cak_DATA)'; test -n "$(apertium_cakdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_cakdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_cakdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_cakdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_cakdir)" || exit $$?; \
	done

uninstall-apertium_cakDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_cak_DATA)'; test -n "$(apertium_cakdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_cakdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_cakdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_cakDATA install-data-local \
...
uninstall-am: uninstall-apertium_cakDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_cakDATA install-data \
	...
	uninstall-am uninstall-apertium_cakDATA \
	uninstall-pkgconfigDATA
